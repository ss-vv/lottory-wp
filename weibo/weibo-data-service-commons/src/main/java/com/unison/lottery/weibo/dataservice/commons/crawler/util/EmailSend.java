...
public class EmailSend {
	 ...
	 *            发送邮件的密码
	 */
	public EmailSend(final String smtpHostName, final String username,
	 ...
	 *            发送邮件的密码
	 */
	public EmailSend(final String username, final String password) {
