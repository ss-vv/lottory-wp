...
public class BBBjEuropeOddsContentData {
	...
	private List<BBMatchEuropeOddDetail> matchEuropeOddDetailList; 
	...
	public List<BBMatchEuropeOddDetail> getMatchEuropeOddDetailList() {
		return matchEuropeOddDetailList;
	}
	public void setMatchEuropeOddDetailList(
			List<BBMatchEuropeOddDetail> matchEuropeOddDetailList) {
		this.matchEuropeOddDetailList = matchEuropeOddDetailList;
	}
	@Override
