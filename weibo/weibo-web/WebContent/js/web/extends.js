...
Followpreview = function() {
    ...
    $(".followpreview").mouseover(function(){
        var h=$(this);
        var b=h.attr("id"),d=h.offset().left,j=h.offset().top+h.height(),g="";
        var e=$("body").width();
        if(e-d<210){
            d=d-186;
        ...
        a[b]=window.setTimeout(function(){
            ...
            if(document.getElementById(l)==null){
                ...
                $.ajax({type: "GET",url:siteurl+"weibo.jsp?api=&op=userpreview&uid="+k+"&class="+g+"&rank="+GetRandomNum(1,999999),success: function(msg){
                    $("#"+l).html(msg).css("backgroundImage","none");
                }});
            }else{
                $("#"+l).fadeIn(500);
            }
