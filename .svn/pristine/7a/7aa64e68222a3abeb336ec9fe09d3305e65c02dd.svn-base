package com.unison.lottery.weibo.web.alipay.alipaycore;
...
public class AlipaySubmit {
     ...
     * @return 签名结果字符串
     */
	public static String buildRequestMysign(Map<String, String> sPara,AlipayBean bean) {
    	String prestr = AlipayCore.createLinkString(sPara); //把数组所有元素，按照“参数=参数值”的模式用“&”字符拼接成字符串
        String mysign = "";
        if("MD5".equals(bean.getSign_type()) ) {
        	mysign = MD5.sign(prestr, bean.getKey(),bean.getInput_charset());
        }
        return mysign;
    }
