...
public class ModifyPasswordMethodResponseParser extends
		AbstractMethodResponseParser {

	@Override
	protected IHaveReturnStatus getResponseFromHttpRequest(
			HttpServletRequest httpRequest) {
		return (IHaveReturnStatus) httpRequest.getAttribute(VONames.MODIFY_PASSWORD_RESPONSE_VO_NAME);
	}
	...
	protected String getDefaultReturnStatusKeyName() {
		return SystemStatusKeyNames.ModifyPassword.FAIL;
	}
