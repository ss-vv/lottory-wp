...
public class AlipayNotify {
	 ...
	 * @return 验证结果
	 */
	public boolean verify(Map<String, String> params, String partner, String alikey) {

		String mysign = getMysign(params, alikey);
	 ...
	 * @return 生成的签名结果
	 */
	private static String getMysign(Map<String, String> Params, String alikey) {
		Map<String, String> sParaNew = AlipayCore.paraFilter(Params);// 过滤空值、sign与sign_type参数
		AlipayCore alipayCore = new AlipayCore();
		String mysign = alipayCore.buildMysign(sParaNew,alikey);// 获得签名结果
		return mysign;
	}
	...
	private static String checkUrl(String urlvalue) {
		...
		try {
			...
			logger.error("Can not visit CheckURL: " + urlvalue, e);
			inputLine = "";
		}
