...
/**
 * 
 * <p>Title: 查询我参加的跟单记录 </p>
 * @author wang lei
 * @version 1.0.0
 */
public class ListMyJoinFollowAction extends BaseListAction {

	private static final long serialVersionUID = 6369031652216990538L;
	@Autowired
	...
	public String execute() {
	    ...
	    betSchemeService.findMyJoinFollowList(paging, status, lotteryId, schemeId, sponsorid, playId, passType,from,to);
		return SUCCESS;
	}
