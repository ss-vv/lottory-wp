...
public class AnySelectionStrategy extends FrequenceLotteryStrategy {
  
  /**
   * 任选
   * @param selectNum 需要选择的数字
   */
  public AnySelectionStrategy(int selectNum){
  ...
  public AnySelectionStrategy(int selectNum, int det,
