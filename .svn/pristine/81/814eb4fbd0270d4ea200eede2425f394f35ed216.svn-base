...
public class HttpClientTestBet {
	private static Logger logger = LoggerFactory
			.getLogger(HttpClientTestBet.class);

	public static void main(String[] args) {
		HttpClient httpclient = new DefaultHttpClient();

		HttpPost httpPost = new HttpPost(
				"http://localhost:80/lottery-partner-bet/bet.do");
//		 "http://58.83.235.132:28080/partner_api/bet");

//		File file = new File("src/test/resources/testBetXmlContent.xml");
		File file = new File("src/test/resources/testBetFC3DXmlContent.xml");
		...
		httpPost.setHeader(Constants.MSG_TYPE, "002");
