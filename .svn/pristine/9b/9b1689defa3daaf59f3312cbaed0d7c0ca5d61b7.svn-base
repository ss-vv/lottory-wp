...
public class GetVerifyCodeMethodResponseParser extends
		AbstractMethodResponseParser {

	@Override
	protected IHaveReturnStatus getResponseFromHttpRequest(
			HttpServletRequest httpRequest) {
		return (IHaveReturnStatus) httpRequest.getAttribute(VONames.GET_VERIFY_CODE_RESPONSE_VO_NAME);
	}
	...
	protected String getDefaultReturnStatusKeyName() {
		return SystemStatusKeyNames.GetVerifyCode.FAIL;
	}
