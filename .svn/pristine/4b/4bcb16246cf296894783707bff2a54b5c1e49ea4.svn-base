...
public class BetSchemePOBase implements Serializable {
	
	public BetSchemePOBase(){
		this.followedSchemeId=-1L;
	}

	private static final long serialVersionUID = -8369575738349125166L;
	...
	@Column(nullable = false, name = "machine_offtime")
	@Temporal(TemporalType.TIMESTAMP)
	...
	@Column(nullable = false, name = "min_bonus", updatable = false)
