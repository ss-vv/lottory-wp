(function($)
{
    ...
    $(document).ready(function()
    {
    	...
    	function showNewMatch(channelObj){
    		var matchChannelIdentifer='match_'+channelObj.matchType+'_'+channelObj.matchId;
    		$("#newMatch").attr("channelIdentifer",matchChannelIdentifer);
    		$("#newMatch").show();
    	}
        ...
        function _metaHandshake(handshake)
        {
            if (handshake.successful === true)
            {
                cometd.batch(function()
                {
                	var channels=[  
                	              {
                	            	  channel:'/public/match/FOOTBALL/201412054003',
                	            	  matchId:'201412054003',
                	            	  matchType:'FOOTBALL'
                	              },
                	              {
                	            	  channel:'/public/match/FOOTBALL/2',
                	            	  matchId:'2',
                	            	  matchType:'FOOTBALL'
                	              },
                	              {
                	            	  channel:'/public/match/BASKETBALL/20141125201',
                	            	  matchId:'20141125201',
