...
/**
 * 
 * <p>Title: 查询我参加的合买记录 </p>
 * @author wang lei
 * @version 1.0.0
 */
public class ListMyJoinGroupbuyAction extends BaseListAction {
	...
	public String execute() {
	    ...
	    betSchemeService.findMyJoinGroupbuyList(paging, status, lotteryId, sponsorid, playId, passType, from, to);
		return SUCCESS;
	}
