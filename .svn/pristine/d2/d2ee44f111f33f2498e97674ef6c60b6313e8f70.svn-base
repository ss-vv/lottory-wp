...
import com.xhcms.lottery.dc.task.crawl.CrawlWorker;

public class CrawlTask extends Job {

    private CrawlWorker guide;
    ...
    public void setGuide(CrawlWorker guide) {
        this.guide = guide;
        this.guide.setTask(this);
    }

    public final void addWorker(CrawlWorker worker){
