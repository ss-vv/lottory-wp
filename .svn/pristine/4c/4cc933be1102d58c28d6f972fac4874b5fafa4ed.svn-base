...
public class BindBankMethodResponseParser extends
		AbstractMethodResponseParser {

	@Override
	protected IHaveReturnStatus getResponseFromHttpRequest(
			HttpServletRequest httpRequest) {
		return (IHaveReturnStatus) httpRequest.getAttribute(VONames.BIND_BANK_RESPONSE_VO_NAME);
	}
	...
	protected String getDefaultReturnStatusKeyName() {
		return SystemStatusKeyNames.BindBank.FAIL;
	}
