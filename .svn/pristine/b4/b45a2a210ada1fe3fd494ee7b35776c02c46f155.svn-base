...
public class SendAdviceMethodRequestParser extends
	...
	protected boolean parseExtendRequestParams(MethodRequest methodRequest,
		...
		String advice=methodRequest.advice;
		httpRequest.setAttribute(VONames.SEND_ADVICE_REQUEST_VO_NAME, advice);
