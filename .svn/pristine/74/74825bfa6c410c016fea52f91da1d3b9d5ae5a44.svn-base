 ...
 * @author 彭保星
 *
 * @since 2014年11月28日上午10:25:00
 */
@Entity
@Table(name = "md_bb_league_score_base")
public class BasketBallLeagueScorePO implements Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = -2505849412027037694L;
	@Id
	private Integer id;
