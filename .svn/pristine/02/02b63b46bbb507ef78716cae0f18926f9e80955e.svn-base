 ...
 * @author 崔桂祥
 */
public interface BasketMatchPlayerStatisticStoreDao {
	 ...
	 * @throws Exception
	 */
	void storeMatchPlayerStatisticData(List<QtBasketMatchPlayerStatisticModel> teamModels) throws Exception;
