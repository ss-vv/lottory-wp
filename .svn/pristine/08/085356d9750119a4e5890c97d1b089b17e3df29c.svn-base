...
public class UserServiceImpl implements IUserService {
	...
	@Override
	@Transactional(readOnly=true)
	public boolean idNumberValid(String idnumber) {
		boolean result=false;
	...
	@Override
	@Transactional
	public void updateToken(String username,String field, String accessToken) {
		UserPO userPO = userDao.getUserByUsername(username);
		if("weixinToken".equals(field)){
			userPO.setWeixinToken(accessToken);
		} else if("qqConnectToken".equals(field)){
			userPO.setQqConnectToken(accessToken);
		} else if("sinaWeiboToken".equals(field)){
			userPO.setSinaWeiboToken(accessToken);
		}
	}
}