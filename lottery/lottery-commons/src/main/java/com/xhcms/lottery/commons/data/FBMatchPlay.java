...
public class FBMatchPlay implements Serializable{
    private static final long serialVersionUID = 7164295336747299458L;
	...
	public FBMatch getMatch() {
		return match;
	}

	public void setMatch(FBMatch match) {
		this.match = match;
	}
