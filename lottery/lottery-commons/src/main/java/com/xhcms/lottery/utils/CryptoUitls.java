...
public class CryptoUitls {
	 ...
	 */
		//用户名签名
		public static final String USERNAME_SIGNATURE = "yI/pShDWJjQ=";
		//密码签名
		public static final String PASSWORD_SIGNATURE = "XV0HSft2dcE=";
		//算法名称
		...
		public static String encrypt(String data, String key,String charset) throws Exception {
			...
			return Base64.encodeBase64String(cipher.doFinal(data.getBytes(charset))); //执行加密操作。加密后的结果通常都会用Base64编码进行传输
		}
		...
		public static void main(String[] args) throws Exception {
			...
			String key = initkey();
//			String key = "vMFdAf2kzny";
			System.out.println("密钥: " + key);
			
			String encryptData = encrypt(source, key);
			System.out.println("加密: " + encryptData);
			
//			String encryptData = "3reu1I0ADJrFx/r9NMrJbw==";
