...
public class BasketBallMatchPO implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -7006592131629872604L;
	@Id
	private long id;
	private String bsId;
	...
	private String isNow; //是否当前的比赛
		
	public BasketBallMatchPO(String name,Date matchTime,String homeTeam,String guestTeam,Integer homeScore,Integer guestScore,Integer letBallNum,String color,String leagueId){
		this.name = name;
	...
	public BasketBallMatchPO(long id,String bsId) {
		this.id = id;
		this.bsId = bsId;
	}
	
	public BasketBallMatchPO(){
