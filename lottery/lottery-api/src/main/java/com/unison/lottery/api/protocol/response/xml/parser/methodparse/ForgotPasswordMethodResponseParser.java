...
public class ForgotPasswordMethodResponseParser extends
		AbstractMethodResponseParser {

	@Override
	protected IHaveReturnStatus getResponseFromHttpRequest(
			HttpServletRequest httpRequest) {
		return (IHaveReturnStatus) httpRequest.getAttribute(VONames.FORGOT_PASSWORD_RESPONSE_VO_NAME);
	}
	...
	protected String getDefaultReturnStatusKeyName() {
		return SystemStatusKeyNames.ForgotPassword.FAIL;
	}
