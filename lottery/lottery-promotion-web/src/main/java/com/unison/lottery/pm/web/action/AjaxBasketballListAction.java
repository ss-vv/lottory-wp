 ...
 *
 */
public class AjaxBasketballListAction extends BaseAction{
    ...
    public String execute() throws Exception {
		List<PromotionWinResult> results = promotionService.findPromotionWinTOP(10,WinGrant.promotion.jclc_2012_6);
