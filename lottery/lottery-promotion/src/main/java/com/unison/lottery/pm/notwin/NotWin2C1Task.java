package com.unison.lottery.pm.notwin;
...
/**
 *  竞彩代购，代购晒单，跟单，2串1玩法，未中奖
 * @author Wang Lei
 *
 */
public class NotWin2C1Task extends Job{
	...
	protected void execute() throws Exception {
		...
		int count=0;
		for(Long schemeId:promotionService.findNotWin2C1PromotionSchemeIds(promotionId)){
			try {
