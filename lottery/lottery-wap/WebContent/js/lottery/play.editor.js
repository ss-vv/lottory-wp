	...
	playEditor.prototype = {
		init: function(option){
			...
			this.observer = {
				save: function(e, data){
					$.post('/play/aj_save.do', data, function(resp){
		...
		initData: function(){
			...
			var html = '<div class="tbebox tbebox_B">'
				...
				+ '<tr><td class="tdl tar"><span class="fc_red">*</span> 彩种：</td><td class="tdr tal"><select name="play.lotteryId"><option value="JCZQ">竞彩足球</option><option value="JCLQ">竞彩篮球</option></select></td></tr>'
