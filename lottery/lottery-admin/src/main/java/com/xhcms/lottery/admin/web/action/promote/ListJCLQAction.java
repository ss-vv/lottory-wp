...
public class ListJCLQAction extends BaseListAction {
    ...
    public String execute(){
        ...
        grantTypes = grantTypeService.JCZCGrantTypeList(Constants.JCLQ);
        promotionServie.listWinGrantPO(paging, from, to, state,winGrant,granttypeId==0?Constants.JCLQ:null);
        return SUCCESS;
    }
